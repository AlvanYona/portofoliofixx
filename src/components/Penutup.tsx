  ...
  return (
    <section className="p-5 mb-20 bg-[#ffbf28] flex flex-col md:flex-row justify-between items-center mt-5 w-full gap-5 rounded-md border-2 border-black shadow-[4px_4px_0_0_black]">
      ...
      <div className="flex flex-col w-full md:w-[50%] gap-4">
        ...
        <button className="mt-4 w-full h-12 rounded-md border-2 border-black bg-white shadow-[4px_4px_0_0_black] text-[17px] font-semibold text-black cursor-pointer active:shadow-none active:translate-x-[2px] active:translate-y-[2px]">
          Send
        </button>
      </div>
