  ...
  return (
    <section className="p-5 mb-20 bg-[#ffbf28] flex flex-col md:flex-row justify-between items-center mt-5 w-full gap-5 rounded-md border-2 border-black shadow-[4px_4px_0_0_black]">
      ...
      <div className="flex flex-col w-full md:w-[50%] gap-4">
        {/* <h2 className="text-black font-black text-xl text-center md:text-left">
        ...
        <input
          ...
          className="w-full h-12 rounded-md border-2 border-black bg-white shadow-[4px_4px_0_0_black] text-[15px] font-semibold text-black p-2 outline-none placeholder:text-gray-600 focus:border-blue-500"
        />

        <textarea
          placeholder="What's we discuss?"
          className="w-full h-32 rounded-md border-2 border-black bg-white shadow-[4px_4px_0_0_black] text-[15px] font-semibold text-black p-2 outline-none placeholder:text-gray-600 focus:border-blue-500 resize-none"
        /> */}

        <a href="mailto:alvanyona581@gmail.com">
          <button className="flex items-center justify-center gap-2 mt-4 w-full h-12 rounded-md border-2 border-black bg-white shadow-[4px_4px_0_0_black] text-[17px] font-semibold text-black cursor-pointer active:shadow-none active:translate-x-[2px] active:translate-y-[2px]">
